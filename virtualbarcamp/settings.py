...
DISCORD_MODERATOR_ROLE_ID = os.environ.get("DISCORD_MODERATOR_ROLE_ID")
DISCORD_WELCOME_CHANNEL_ID = os.environ.get("DISCORD_WELCOME_CHANNEL_ID")
DISCORD_SYNC_DISABLED = os.environ.get("DISCORD_SYNC_DISABLED") == "True"
